...
public class AccountSummaryPage {
    private final com.zerobank.pages.AccountSummaryPage accountSummaryPage;

    public AccountSummaryPage(com.zerobank.pages.AccountSummaryPage accountSummaryPage) {
